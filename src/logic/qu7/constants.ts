 ...
 * 母音.
 */
export const VOWELS_LOWER = ['a', 'e', 'i', 'o', 'u'];

/**
 * 母音で始まる単語に追加する接尾辞
 */
export const SUFFIX_FOR_VOWELS = 'way';

/**
 * 子音で始まる単語に追加する接尾辞
 */
export const SUFFIX_FOR_CONSONANTS = 'ay';
...
export const testCases: TestCase[] = [
  ...
  },
  {
    ...
    expected: 'Ythmrhay!', // ★ 修正なし (元々正しかった)
