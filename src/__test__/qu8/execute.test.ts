...
import { main } from '@/logic/qu8/execute';
import {
  PATHS_NORMAL,
  PATHS_MIXED_SIBLINGS,
  PATHS_INTERMEDIATE_DOT,
  PATHS_MULTIPLE_SUB_DIRS,
  PATHS_CONFLICT_FILE_AS_DIR,
  PATHS_CONFLICT_DIR_AS_FILE
} from '@/logic/qu8/constants';

type TestCase = {
  name: string;
  paths: string[];
  expectedTree: Record<string, any>;
